...
class CustomInputField extends StatelessWidget {
  ...
  String text;
  bool isMultiLine;
  CustomInputField({this.label = '',this.hint = "", this.text = "", this.obscureText = false,required this.controller,required this.errorMsg, this.isPhone = false, this.isNumber = false, this.isMultiLine = false});
  @override
