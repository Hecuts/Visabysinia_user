  ...
  void fetchData(double lat, double long ) async {
    ...
    * */
    try {
      ...
      var itemsList = await Future.wait([_repository.fetchAttractions(lat,long),_repository.fetchHotels(latCopy,longCopy)]);//
      ...
      Get.snackbar("Message", "Error occurred while fetching data....",snackPosition: SnackPosition.BOTTOM,
